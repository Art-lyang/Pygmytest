...
export const TYPES = {
  ...
  strategist: {
    index: '06', name: '든든한 계획형 집사', short: '계획형', en: 'THE PLANNER',
    tagline: '오늘의 돌봄부터 먼 훗날까지 차근차근 준비하는 기획자',
    summary: '계절과 생활 변화까지 미리 내다보는 집사',
    description: '당신은 지금 필요한 돌봄뿐 아니라 계절 변화, 장기 부재, 병원 방문처럼 앞으로 생길 상황까지 미리 생각합니다. 계획을 세우고 필요한 것을 차근차근 준비하는 일을 좋아하며, 피그미가 오래 안정적으로 지낼 수 있는 생활을 중요하게 생각합니다.',
    traits: ['장기 계획', '비상 대비', '생활 설계', '꾸준한 준비'],
    strengths: ['계절과 생활 변화에 필요한 준비를 미리 챙깁니다.', '돌봄을 맡길 사람과 비상 상황까지 차분히 고려합니다.', '감에 의존하지 않고 선택지와 결과를 비교하는 데 익숙합니다.'],
    watchouts: ['완벽한 계획보다 지금 피그미가 보내는 신호를 먼저 살펴보세요.', '예상과 달라도 실패로 여기지 말고 유연하게 계획을 바꿔보세요.'],
    routine: '계절별 준비물, 병원 정보, 비상 연락처, 대체 돌봄 방법을 한 장에 정리하고 아직 준비되지 않은 항목을 표시해 보세요.',
    fit: '규칙적인 생활을 좋아하거나 환경 변화에 천천히 적응하는 개체와 잘 맞습니다.',
    secondaryCopy: '계획에 관찰과 교감 기준을 더하면 안정적이면서도 유연한 돌봄이 완성됩니다.',
