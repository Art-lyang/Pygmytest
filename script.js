...
const MORPHS = [
  {
    ...
    image: 'https://picsum.photos/seed/normal-morph/400/300',
    name: '노말',
    nameEn: 'Normal',
    emoji: '🌿',
    tagline: '자연 그대로의 따뜻함',
  ...
  },
  {
    id: 'ringtail',
    // ↓ 실제 모프 사진으로 교체하세요 (권장 400×300px 이상)
    image: 'https://picsum.photos/seed/ringtail-morph/400/300',
    name: '링테일',
    nameEn: 'Ring Tail',
    emoji: '🌀',
    tagline: '눈길을 끄는 개성파',
  ...
  },
  {
    id: 'pied',
    // ↓ 실제 모프 사진으로 교체하세요 (권장 400×300px 이상)
    image: 'https://picsum.photos/seed/pied-morph/400/300',
    name: '파이드',
    nameEn: 'Pied',
    emoji: '🤍',
    tagline: '독특한 패턴의 소유자',
  ...
  },
  {
    id: 'oreo',
    // ↓ 실제 모프 사진으로 교체하세요 (권장 400×300px 이상)
    image: 'https://picsum.photos/seed/oreo-morph/400/300',
    name: '오레오',
    nameEn: 'Oreo',
    emoji: '🍪',
    tagline: '흑백의 선명한 대비',
  ...
  },
  {
    id: 'dalmatian',
    // ↓ 실제 모프 사진으로 교체하세요 (권장 400×300px 이상)
    image: 'https://picsum.photos/seed/dalmatian-morph/400/300',
    name: '달마시안',
    nameEn: 'Dalmatian',
    emoji: '✨',
    tagline: '별처럼 흩뿌려진 매력',
  ...
  },
  {
    id: 'mask',
    // ↓ 실제 모프 사진으로 교체하세요 (권장 400×300px 이상)
    image: 'https://picsum.photos/seed/mask-morph/400/300',
    name: '마스크',
    nameEn: 'Mask',
    emoji: '🎭',
  ...
  },
  {
    id: 'high-white',
    // ↓ 실제 모프 사진으로 교체하세요 (권장 400×300px 이상)
    image: 'https://picsum.photos/seed/highwhite-morph/400/300',
    name: '하이화이트',
    nameEn: 'High White',
    emoji: '☁️',
    tagline: '순백의 포근한 솜털',
  ...
  },
  {
    id: 'lucistic',
    // ↓ 실제 모프 사진으로 교체하세요 (권장 400×300px 이상)
    image: 'https://picsum.photos/seed/lucistic-morph/400/300',
    name: '루시스틱',
    nameEn: 'Lucistic',
    emoji: '🌕',
    tagline: '달빛처럼 은은한 빛',
  ...
  },
  {
    id: 'black',
    // ↓ 실제 모프 사진으로 교체하세요 (권장 400×300px 이상)
    image: 'https://picsum.photos/seed/black-morph/400/300',
    name: '블랙',
    nameEn: 'Black',
    emoji: '🖤',
    tagline: '강렬한 존재감',
...
const FUNNY_QUESTIONS = [
  ...
  {
    text: "피그미다람쥐가 내 회의에 乱입했다. 상사 반응은?",
    options: [
...
/* ============================================================
   3. 앱 상태 변수
   ============================================================ */
let currentQuestions = []; // 이번 회차에 뽑힌 10개 질문
let currentIndex = 0;      // 현재 진행 중인 질문 인덱스
let scores = {};           // 모프별 누적 점수 { morphId: number }
let quizStartTime = null;  // 테스트 시작 시각 (소요 시간 측정용)
    ...
    if (morph.image) {
      imgEl.innerHTML = `
        <img src="${morph.image}"
             ...
             loading="lazy">
        <div class="res-image-caption">${morph.name} 모프 · 실제 사진으로 교체 예정</div>
      `;
  ...
  try {
    ...
    Kakao.Share.sendDefault({
      ...
      content: {
        ...
        imageUrl: 'https://pygmytest.com/og-image.jpg', // ← OG 이미지 URL
        link: {
